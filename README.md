...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dsconfig-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13501&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dsconfig-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dsconfig` can be installed with:

```
conda install dsconfig
```

It is possible to list all of the versions of `dsconfig` available on your platform with:
